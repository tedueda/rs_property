...
export function UnitDetailPage() {
  ...
  const [unit] = useState<Unit>({
    id: id || '1', property_id: '1', company_id: '1', unit_number: '101', floor: 1,
    layout: '1K', area_sqm: 25, rent_amount: 75000, management_fee: 5000,
    water_fee: 2000, parking_fee: 0, deposit: 75000, key_money: 75000,
    status: 'occupied', created_at: '', updated_at: '',
    property: { id: '1', company_id: '1', name: 'サンハイツA棟', address: '東京都新宿区西新宿1-1-1', total_units: 24, created_at: '', updated_at: '' }
  })
  ...
  return (
    <div>
      <PageHeader
        title={`${unit.property?.name || ''} ${unit.unit_number}号室`}
        backTo="/units"
